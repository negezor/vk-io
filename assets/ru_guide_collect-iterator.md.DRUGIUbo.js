import{_ as a,c as i,o as n,ae as l}from"./chunks/framework.FWzobDMP.js";const o=JSON.parse('{"title":"Collect Iterator","description":"","frontmatter":{},"headers":[],"relativePath":"ru/guide/collect-iterator.md","filePath":"ru/guide/collect-iterator.md"}'),e={name:"ru/guide/collect-iterator.md"};function t(p,s,h,k,r,c){return n(),i("div",null,[...s[0]||(s[0]=[l(`<h1 id="collect-iterator" tabindex="-1">Collect Iterator <a class="header-anchor" href="#collect-iterator" aria-label="Permalink to &quot;Collect Iterator&quot;">​</a></h1><p>Хелпер модуль позволяющий упростить получение данных</p><h2 id="описание-типов" tabindex="-1">Описание типов <a class="header-anchor" href="#описание-типов" aria-label="Permalink to &quot;Описание типов&quot;">​</a></h2><p><a href="https://negezor.github.io/vk-io/references/vk-io/index.html#createCollectIterator" target="_blank" rel="noreferrer">API Reference [EN]</a></p><h2 id="концепт" tabindex="-1">Концепт <a class="header-anchor" href="#концепт" aria-label="Permalink to &quot;Концепт&quot;">​</a></h2><p>Множество методов возвращают только часть данных, и для получения остальной части — нужно указывать смещение. Для этого в библиотеке есть итератор который автоматический ставит смещение.</p><h2 id="пример" tabindex="-1">Пример <a class="header-anchor" href="#пример" aria-label="Permalink to &quot;Пример&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { API, createCollectIterator } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;vk-io&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,8)])])}const E=a(e,[["render",t]]);export{o as __pageData,E as default};
