...
## Roadmap
- [4.0.0] Переход на ES2015 систему подключения модуля, удаление устаревшего API. Полное переписание модуля на производительность. Минимальная версия Node.js 7.X
...
## [3.2.0] - 18.08.2017
### Добавлено
- Добавлен новый метод `docs.getMessagesUploadServer`
- Добавлен новый метод загрузки `messageDoc`

### Исправлено
- Исправлен баг удаление первого символа в парсинге пересылаемых сообщений
- Исправлен метод загрузки аудисообщений
- Обновлена зависимость `debug` до `3.0.0`
- Обновлена версия API до `5.68`
- Обновлён `User-Agent`

### Удалено
- Удалены методы `groups.getCallbackServerSettings`, `groups.setCallbackServerSettings`, `groups.setCallbackServer`
